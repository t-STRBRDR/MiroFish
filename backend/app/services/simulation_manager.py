...
Using preset scripts + LLM intelligent configuration parameter generation
"""
...
class SimulationManager:
    ...
    Core features:
    1. Read and filter entities from Zep knowledge graph
    ...
    def prepare_simulation(
        ...
        try:
            ...
            if filtered.filtered_count == 0:
                ...
                state.error = "No matching entities found, please check if the knowledge graph is correctly built"
                self._save_simulation_state(state)
                return state
            ...
            # Reddit was already saved in real-time during generation, save again to ensure completeness
            if progress_callback:
                progress_callback(
