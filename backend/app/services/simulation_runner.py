...
Run simulation in background and record each Agent's actions, with real-time status monitoring
"""
...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        max_rounds: int = None,  # Maximum simulation rounds (optional, to truncate long simulations)
        enable_graph_memory_update: bool = False,  # Whether to update activities to Zep knowledge graph
        ...
        Args:
            ...
            max_rounds: Maximum simulation rounds (optional, to truncate long simulations)
            enable_graph_memory_update: Whether to dynamically update Agent activities to Zep knowledge graph
                        ...
                        try:
                            ...
                            if "event_type" in action_data:
                                ...
                                # Update round info (from round_end event)
                                    ...
                                    # Overall round takes maximum of both platforms
    ...
    def get_all_actions(
        ...
        # If per-platform files don't exist, try reading legacy single file format
        if not actions:
    ...
    def register_cleanup(cls):
        ...
        # If not debug mode, this env var doesn't exist, also need to register
        ...
        def cleanup_handler(signum=None, frame=None):
            ...
            # Only print logs when there are processes to clean
    ...
    def close_simulation_env(
        ...
        """
        Close simulation environment (without stopping simulation process)
